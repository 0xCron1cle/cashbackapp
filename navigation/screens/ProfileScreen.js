...
import { Modal, Text, View, TouchableOpacity, TextInput, Animated, Image, Linking, Platform, } from 'react-native';
...
export default function ProfileScreen({ navigation }) {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      icon: "credit-card",
      info: "Mastercard",
      url: null // Keine URL, weil Kartenzahlung evtl. intern behandelt wird
    },
    {
      id: "applePay",
      label: "Apple Pay",
